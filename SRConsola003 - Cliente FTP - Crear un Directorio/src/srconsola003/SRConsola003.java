 ...
 * login, se cambia el directorio activo, se crea un directorio, se hace logout
 * y se cierra la conexión con el servidor
 *
 * @author Ignacio Fontecha Hernández
 * @version 1.0
 * @since PSP 1.0
 */
public class SRConsola003 {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Cambiando al directorio /home/usuario/docs ");
            clienteFTP.changeWorkingDirectory("docs");
            mostrarRespuesta(clienteFTP);

            System.out.println("Creando el directorio prueba2024");
            boolean subida = clienteFTP.makeDirectory("prueba2024");
            mostrarRespuesta(clienteFTP);
