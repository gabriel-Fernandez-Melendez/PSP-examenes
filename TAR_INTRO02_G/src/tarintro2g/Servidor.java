...
public class Servidor extends JFrame implements ActionListener {
	...
	/**
	 * Función para recibir conexiones desde los alumnos. El servidor se mantiene
	 * continuamente a la espera de nuevas conexiones y, cuando acepta alguna, crea
	 * un HiloServidor para ella, lo lanza y aumenta el valor de CONEXIONES.
	 */
	private static void recibirConexiones() { //es el unico metodo que tiene el servidor y que esta siempre a la escucha
		try {
